...
class _RoamioMap {
   ...
   * @param {string | null} key - a unique identifier for the marker (autogenerated if left empty)
   */
  addMarker(latLng, key = null) {
    if (this.markers.has(key)) {
      return;
    }

    const marker = L.marker(latLng);
    const markerKey = key || this.markers.size.toString();
