...
export const getLocationSearchApiRoute = (query) => `${API_BASE_ROUTE}/locations/search?query=${query}`;
export const getUserSearchApiRoute = (query, tripId) => `${API_BASE_ROUTE}/users/search?trip_id=${tripId}&query=${query}`;
